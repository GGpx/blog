<?php
include_once 'articles/json/objet_articles.php';
...
<head>
    ...
    <script src="articles/js/show_title_art.js"></script>
    <script src="articles/js/change_title_art.js"></script>
    <script src="articles/js/delete_title_art.js"></script>
 ...
 **
 -->
        ...
        <div class="div_bdd" id="<?=$title_article['id']?>">
            ...
            <p id="c_id"><?=$title_article['id']?></p>
            <p id="c_title"><?=$title_article['title']?></p>
            <p id="c_article"> <?=$title_article['article']?> </p>
            ...
            onclick="deleteTitle_art(<?=$title_article['id']?>)"
        </div>
    ...
    <!-- <script src="articles/jquery/c_title_art.js"></script> -->
    <!-- <script src="articles/jquery/d_title_art.js"></script> -->
</body>
